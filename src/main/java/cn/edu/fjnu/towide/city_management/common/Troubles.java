...
public class Troubles implements Serializable{
	...
	private List<TroubleOperation> troubleOperations;
	public Long getId() {
		return id;
	}
	...
	public List<TroubleOperation> getTroubleOperations() {
		return troubleOperations;
	}
	public void setTroubleOperations(List<TroubleOperation> troubleOperations) {
		this.troubleOperations = troubleOperations;
	}
	@Override
	public String toString() {
		return "Troubles [id=" + id + ", reportCitizenTelephoneNumber=" + reportCitizenTelephoneNumber
				...
				+ ", satisfactionEvaluation=" + satisfactionEvaluation + ", flag=" + flag + ", troubleOperations="
				+ troubleOperations + "]";
	}
	public Troubles(Long id, String reportCitizenTelephoneNumber, Long reportStaffId, Long reportDepartmentId,
			Long stayDepartmentId, Long disposeStaffId, String sceneDescription, String sceneAddress,
			Timestamp reportDatetime, Integer processState, Integer urgencyLevel, Integer satisfactionEvaluation,
			Integer flag, List<TroubleOperation> troubleOperations) {
		super();
		this.id = id;
		this.reportCitizenTelephoneNumber = reportCitizenTelephoneNumber;
		this.reportStaffId = reportStaffId;
